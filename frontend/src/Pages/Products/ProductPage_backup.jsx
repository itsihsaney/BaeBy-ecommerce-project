        ...
        <>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 text-center">
                    <h3 className="text-lg font-semibold text-gray-700">{product.name || product.title}</h3>
          ...
          <div className="flex justify-center items-center gap-3 mt-12">
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-medium shadow-md transition-all duration-200 ${currentPage === 1
            ...
            <div className="flex gap-2">
              {[...Array(totalPages)].map((_, i) => (
                <button
                  ...
                  className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-200 ${currentPage === i + 1
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-medium shadow-md transition-all duration-200 ${currentPage === totalPages
                ? "bg-gray-200 text-gray-500 cursor-not-allowed"
                : "bg-pink-500 hover:bg-pink-600 text-white"
                }`}
            >
