...
function Clothes() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-10">
      <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Baby Clothes</h2>
            ...
            >
              ...
              <button
                ...
                className={`absolute top-3 right-3 p-2 rounded-full transition-all ${
                  isWishlisted ? "bg-pink-500 text-white" : "bg-gray-200 text-gray-600 hover:bg-pink-100"
                }`}
              >
